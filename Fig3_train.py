...
for N_seg in range(1,15):
    
    type_init, train_optical = "F{}".format(N_seg), False
    ...
    Unitary_init = F[type_init[1:]]*(type_init[0]=="F") 
    ...
    torch.save({
        ...
        "val_loss": val_loss,
        "lr": lr,
    }, "Data_Fig3/net_type{}_train{}.pt".format(type_init,train_optical))
